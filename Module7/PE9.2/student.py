...
def main():
    ...
    random.shuffle(lyst)  # Shuffle the list using the import statement random

    # print the unsorted list of students first
    print("unsorted list of students: ")
    for obj in lyst:
        print(obj.__str__())

    print("")  # print a blank line
    lyst.sort()  # Sort the list using the sort() method
